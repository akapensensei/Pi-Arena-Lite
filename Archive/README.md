# Pi-Arena-Lite
Modular FRC (First Robotics Competition) FMS (Field Management System)
...
A wise person would stay away until this software is thoroughly tested. Once we complete that, we will remove this warning.
